...
movedObject = ObjectSighting.newSighting({Patch(GrayHistogram([0; 1]), Area.fromXYtoXY(10, 10, 12, 12))});
...
movedObject = ObjectSighting.newSighting({Patch(GrayHistogram([1; 0]), Area.fromXYtoXY(10, 10, 12, 12))});
nextFrame = zeros(20, 20); 
...
movedObject = ObjectSighting.newSighting({Patch(NaN, Area.fromXYtoXY(10, 10, 12, 12))});
