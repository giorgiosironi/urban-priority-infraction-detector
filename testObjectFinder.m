...
finder = ObjectFinder(PatchesSelector(10, 10), ForegroundValidityStrategy(1), LabelsContainerFactory());
content = ones(100) * -1;
content(11:20, 11:40) = ones(10, 30);
content(11:50, 51:60) = ones(40, 10);
factory = IntegralHistogramFactory(GrayHistogramStrategy(16));
histograms = factory.buildFromImage(content);
objects = finder.findInForeground(Frame(content), histograms);
