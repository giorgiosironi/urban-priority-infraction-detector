...
%this should be done only inside detectCollisions(): objectsTheoreticallyOccupiedSpace = rectifiedModelledObjectsByTrajectories.filterPositions(MaxSpeedPositionFilter());
priorityRules = PriorityRules(MaxSpeedPositionFilter());
priorityRules.addPriority(2, 3);
collidedObjects = objectsTheoreticallyOccupiedSpace.detectCollisions(priorityRules);
