...
object1InFirst = ObjectSighting({Area.fromXYtoXY(1, 1, 10, 10)});
object2InFirst = ObjectSighting({Area.fromXYtoXY(100, 100, 110, 110)});
object3InFirst = ObjectSighting({Area.fromXYtoXY(50, 150, 60, 160)});
object1InSecond = ObjectSighting({Area.fromXYtoXY(11, 11, 20, 20)});
object2InSecond = ObjectSighting({Area.fromXYtoXY(110, 110, 120, 120)});
object3InSecond = ObjectSighting({Area.fromXYtoXY(60, 160, 70, 170)});
